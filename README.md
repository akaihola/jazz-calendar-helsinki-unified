# jazz-calendar-helsinki-unified
...
A unified, de-duplicated public iCalendar (RFC 5545) feed of jazz concerts in the Helsinki metropolitan area. The feed merges two upstream sources, refreshes every 6 hours, and is served by GitHub Pages at:
